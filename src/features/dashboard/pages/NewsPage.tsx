...
import { mockNews } from '../model/mockData'
    ...
    <div className="p-4 lg:p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {filteredNews.map((news) => (
          <div key={news.id} className="group rounded-xl border border-border bg-card p-6 transition-all hover:shadow-lg">
      ...
      {filteredNews.length === 0 && (
        <div className="mt-8 text-center text-muted-foreground">No news found matching your criteria</div>
      )}
    </div>
  )
}
